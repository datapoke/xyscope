...
RUN apt-get install -y --no-install-recommends \
  ...
  libdouble-conversion1 libepoxy0 libevdev2 libffado2 libglibmm-2.4-1v5 libgtk-3-0 \
  libgtk-3-bin libgtk-3-common libgudev-1.0-0 libidn11 libinput-bin libinput10 libip4tc0 \
  libjson-c3 libjson-glib-1.0-0 libjson-glib-1.0-common libkmod2 libmtdev1 libnss-systemd \
  ...
  libxcb-util0 libxcb-xinerama0 libxcb-xkb1 libxcomposite1 libxkbcommon-x11-0 \
